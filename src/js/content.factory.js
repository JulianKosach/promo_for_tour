	...
	var obj = {
		content: {
			...
			form: {
				...
				groupTourLbl: {
					ua: 'Приєднатись до збірної групи (5 вільних місць)',
					ru: 'Присоединиться к сборной группе (5 свободных мест)'
				},
				indivTourLbl: {
					ua: 'Замовити для окремої групи',
					ru: 'Заказать для отдельной группы'
				},
				countLbl: {
					ua: 'Кількість осіб',
